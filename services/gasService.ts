...
const MOCK_UNITS: Unit[] = [
  // Unit Beruniform
  { id: 'ub1', name: 'Pengakap', category: UnitCategory.UNIT_BERUNIFORM, password: 'SCOUT', logoUrl: 'https://penangscout.org/images/info/PPM-logo2009.jpg', teachers: ["Amirul Ariff Bin Yusof", "Wan Ahmad Bin Wan Ibrahim", "Sharwintharan A/L Thavarajah", "Muhammad Ihsan B. Shaik Ali", "Muhammad Yasin Bin Abdul Aziz", "Magaletchumi A/P Veerappen", "Nur Zuhaira Binti Mohamed Salib", "Vineeta A/P Singaraveloo"], aliases: ["PENGAKAP"] },
  { id: 'ub2', name: 'Tunas Kadet Remaja Sekolah (TKRS)', category: UnitCategory.UNIT_BERUNIFORM, password: 'KADET', logoUrl: 'https://vectorise.net/logo/wp-content/uploads/2019/02/Logo-Kadet-Remaja-Sekolah-new.png', teachers: ["Muhammad Sufian Bin Mustafa Bakri", "Nur Izzati Binti Mohd. Khalil", "Norlizam Bin Idrose", "Muhammad Ammar Bin Mustafa", "Mohamad Solehuhafiz B. Mohd. Suhaimi", "Nur Elya Bt. Mohd. Zin", "Nur Hazierah Binti Azmi", "Chin Ning Yan"], aliases: ["TKRS"] },
  { id: 'ub3', name: 'Puteri Islam', category: UnitCategory.UNIT_BERUNIFORM, password: 'PPIM', logoUrl: 'https://codecblend.com/v3/images/stories/virtuemart/product/pergerakan-puteri-islam-malaysia-ppim-thumbnail.jpg', teachers: ["Nur Hidayah Binti Abdul Jalil", "Afiyefah Binti Mohd Alim", "Nur Izzati Binti Samsudin", "Radhiah Binti Zainon", "Aina Amirah Binti Halim", "Nurfatin Afiqah Binti Hamzah", "Noor Hidayah Bt. Salleh"], aliases: ["PUTERI"] },
  { id: 'ub4', name: 'Pandu Puteri Tunas', category: UnitCategory.UNIT_BERUNIFORM, password: 'TUNAS', logoUrl: 'https://vectorise.net/logo/wp-content/uploads/2012/04/Logo-Persatuan-Pandu-Puteri-Malaysia.png', teachers: ["Ng Shi Hui", "Dr. Renukha A/P Nallasamy", "Nur Zuhaira Binti Mohd Fauzi", "Nur Syafiqah Binti Nizamdin", "Hamdina Nurarifah Binti Ahmad @ Zamri", "Saridah Tk Md Yusoff", "Punitha A/P Munusamy", "Pamela Khoo Bee Lay", "Nur Izzany Binti Mohd"], aliases: ["PANDU"] },
  
  // Kelab & Persatuan
  { id: 'kp1', name: 'Kelab Doktor Muda', category: UnitCategory.KELAB_PERSATUAN, password: 'MEDIK', logoUrl: 'https://cdn-icons-png.flaticon.com/512/2965/2965567.png', teachers: ["Aina Amirah Binti Halim", "Chin Ning Yan", "Amirul Ariff Bin Yusof", "Nur Izzati Binti Samsudin", "Nur Izzany Binti Mohd"], aliases: ["KDM"] },
  { id: 'kp2', name: 'Kelab STEM & Robotik', category: UnitCategory.KELAB_PERSATUAN, password: 'ROBOT', logoUrl: 'https://cdn-icons-png.flaticon.com/512/471/471231.png', teachers: ["Wan Ahmad Bin Wan Ibrahim", "Muhammad Sufian Bin Mustafa Bakri", "Nur Zuhaira Binti Mohamed Salib"], aliases: ["STEM"] },
  { id: 'kp3', name: 'Kelab Kitar Semula', category: UnitCategory.KELAB_PERSATUAN, password: 'HIJAU', logoUrl: 'https://cdn-icons-png.flaticon.com/512/893/893257.png', teachers: ["Asqalani Bin Suhaimi", "Nur Izzati Binti Mohd. Khalil", "Magaletchumi A/P Veerappen", "Muhammad Ammar Bin Mustafa"], aliases: ["KITAR"] },
  ...
  { id: 'kp6', name: 'Persatuan Bahasa', category: UnitCategory.KELAB_PERSATUAN, password: 'KATA', logoUrl: 'https://cdn-icons-png.flaticon.com/512/149/149852.png', teachers: ["Hamdina Nurarifah Binti Ahmad @ Zamri", "Sharwintharan A/L Thavarajah", "Nur Elya Bt. Mohd. Zin", "Dr. Renukha A/P Nallasamy", "Saridah Tk Md Yusoff"], aliases: ["BAHASA"] },
  { id: 'kp7', name: 'Persatuan Agama Islam', category: UnitCategory.KELAB_PERSATUAN, password: 'IMAN', logoUrl: 'https://cdn-icons-png.flaticon.com/512/603/603179.png', teachers: ["Nur Hidayah Binti Abdul Jalil", "Afiyefah Binti Mohd Alim", "Radhiah Binti Zainon", "Nurfatin Afiqah Binti Hamzah", "Noor Hidayah Bt. Salleh"], aliases: ["PAI"] },
  ...
  { id: 's5', name: 'Olahraga', category: UnitCategory.SATU_M_SATU_S, password: 'LARI', logoUrl: 'https://cdn-icons-png.flaticon.com/512/186/186242.png', teachers: ["Punitha A/P Munusamy", "Chin Ning Yan", "Ng Shi Hui", "Norlizam Bin Idrose", "Sharwintharan A/L Thavarajah", "Muhammad Yasin Bin Abdul Aziz"], aliases: ["OLAHR"] },
  { id: 's6', name: 'Catur', category: UnitCategory.SATU_M_SATU_S, password: 'CATUR', logoUrl: 'https://cdn-icons-png.flaticon.com/512/3304/3304444.png', teachers: ["Nur Izzati Binti Mohd. Khalil", "Muhammad Sufian Bin Mustafa Bakri", "Nur Zurainee Binti Mohd Fauzi", "Magaletchumi A/P Veerappen", "Aina Amirah Binti Halim"], aliases: ["CATUR"] },
];
